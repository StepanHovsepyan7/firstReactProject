...
import { faMagnifyingGlass, faCaretDown, faLocationDot } from '@fortawesome/free-solid-svg-icons';
                    ...
                    <div className="w-full h-full pb-5 shadow-[0px_30px_60px_-15px_#8F90BC26] backdrop-blur-[20px] bg-[rgba(255,255,255,0.8)] rounded-lg lg:w-[948px]">
                        <div className="flex pl-5 pt-5 gap-10 flex-wrap">
                            <div className="flex flex-col text-start">
                                <h4 className="text-[15px] lg:text-[20px] font-normal">Location</h4>
                            ...
                            <div className="flex flex-col text-start">
                                <h4 className="text-[15px] lg:text-[20px] font-normal">Property Type</h4>
                                <p className="text-[#8F90A6] text-[15px] lg:text-[20px] font-normal flex items-center gap-2">
                            ...
                            <div className="flex flex-col text-start">
                                <h4 className="text-[15px] lg:text-[20px] font-normal">Price Range</h4>
                                <p className="text-[#8F90A6] text-[15px] lg:text-[20px] font-normal flex items-center gap-2">
                                    Choose Price Range
                                    <FontAwesomeIcon icon={faLocationDot} className="cursor-pointer" />
                                </p>
                            </div>
                            <div className="flex items-center ml-auto mr-3 bg-[#1DAEFF] rounded-lg h-[62px] w-[62px] justify-center cursor-pointer">
